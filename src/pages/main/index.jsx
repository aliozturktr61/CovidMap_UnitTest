...
//verilerin olduğu json dosyaının url i
...
{/* harita için gerekli ayarları yapılmalı */}
      <ComposableMap height={1000}>
        <ZoomableGroup zoom={2}>
          {/* dünya haritasının dışındaki enlem boylam çizgileri için */}
          <Graticule stroke="gray" strokeWidth={0.3} />
          {/* dünya haritasının dışındaki sınır çizgisi için */}
          ...
          {/* farenin tekerleğiyle büyütüp küçültmek için */}
        </ZoomableGroup>
      </ComposableMap>
    </div>
  );
